...
urlpatterns = [
    ...
    url(r'^(?P<pk>[0-9a-f-]+)/detail/$', DetailView.as_view(), name='detail'),
    ...
    url(r'^(?P<urluniqueid>[0-9a-f-]+)/set/(?P<process_name>[0-9]+)/$', set_process_template, name='set_process_template'),
